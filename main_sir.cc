...
int main(){
  ...
  cout << "What percentage of the population is vaccinated? (enter as a decima\
l)\n";
  cin>>amount_vacc;
  ...
  cout << "It took " << runtime << " days for the disease to run through a pop\
ulation of " << pop_size << " \n";
